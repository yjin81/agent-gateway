// sdk-ts/src/types.ts
// IMPORTANT: This file must be kept byte-identical to packages/gateway/src/harness/types.ts
// A CI check enforces this. Do NOT edit this file directly — edit harness/types.ts first.

// Re-export MediaItem from connectors so harness authors have a single import point.
export type { MediaItem, Mention } from './connector-types.js'
...
export interface AgentRequest {
  ...
  media: import('./connector-types.js').MediaItem[]
  ...
  platform: {
    ...
    userName: string
    accountId: string
    mentions: import('./connector-types.js').Mention[]
  }
