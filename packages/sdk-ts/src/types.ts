// sdk-ts/src/types.ts
// IMPORTANT: This file must be kept byte-identical to packages/gateway/src/adapter/types.ts
// A CI check enforces this. Do NOT edit this file directly — edit adapter/types.ts first.
